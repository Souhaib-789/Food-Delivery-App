  ...
  return(
    ...
    <View style={styles.container}>
      ...
      <View style={{margin: 40}}>
          <Text style={{fontSize: 30, fontWeight: 'bold', color: 'black'}}>Thank You </Text>
      </View>
      <View>
          <Text style={{fontSize: 25,textAlign: 'center', color: 'black'}}>Your Order has been placed succcessfully!</Text>
      </View>
